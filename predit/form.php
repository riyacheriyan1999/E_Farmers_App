...
echo "<select name='$name' class='form-control'>";
		...
		echo "<option value='1'>Monsoon</option>";
		echo "<option value='2'>Summer</option>";
		echo "<option value='3'>Winter</option>";
		echo "<option value='4'>Autumn</option>";
		echo "<option value='5'>Spring</option>";
...
echo "<select name='$name' class='form-control'>";
		...
		echo "<option value='1'>clay</option>";
		echo "<option value='2'>Loamy</option>";
		echo "<option value='3'>Sandy</option>";
...
<div class='col-md-12'>
                              <div class='col-md-3'>              <div class='form-group'>
											<input type='submit' value='Predict Now' name='submit' class='form-control btn-success'>";
