...
<section class="news" id="news">
		<div class="container">
            ...
            <?php
			$result = mysqli_query($con,"SELECT * FROM product WHERE status='stock' and sales_qty!=0");
			...
			<div class="news-grids">
				<div class="col-md-4 news-grid1">
					...
					<h3> <?php echo $row['name']; ?></h3>
						...
						<div class="more">
							<a href="sales.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#myModal" >View PRODUCT</a>
						</div>
				</div>
                <?php
		}
