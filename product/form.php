...
elseif($name=="status"){
	  ...
	  ".str_replace('_', ' ', $name)."</label><input type='text' name='$name' class='form-control' value='stock' readonly> </div>
                                        </div>";
	
		 
}

elseif($name=="farmer_id")
{
...
elseif($name=="krishibhavan")
{
		 
		 echo "
	  
	  <input type='hidden' name='$name' class='form-control' value='$_SESSION[krishibvan]' readonly>";
...
<form action='select.php' method='post'><input type='submit' name='view' value='View All' class=''></form></div></div>
