...
<head>
  ...
  <title>E-Farm-One step Platform for Farmers </title>
  ...
  <header id="headers4-block">
      <div class="wrapper">
          <div class="d-grid nav-mobile-block header-align">
              <div class="logo">
                  <a class="brand-logo" href="index.php"><span><span class="fa fa-viadeo" aria-hidden="true"></span> E-Farm</span></a>
                  ...
                  <ul class="menu">
				   ...
				   <?php 
						 ...
						 <li><a href="../login/index.php?st=logout" class="  hvr-underline-from-center">Logout</a></li>
							...
							{
							?>
                             <li><a href="../login/signup.php"  class=" hvr-underline-from-center">Registration</a></li>
							    <li><a href="../login/login.php"  class=" hvr-underline-from-center">Login</a></li>
                             <?php
							}
							?>
